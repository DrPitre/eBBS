...
int bbs_enum_accounts __P((SHORT, SHORT, int (*)(int, ACCOUNT *, void *), void *));
int bbs_enum_users __P((SHORT, SHORT, char *, int (*)(int, USEREC *, void *), void *));
...
int bbs_enum_headers __P((SHORT, SHORT, SHORT, int (*)(int, HEADER *, void *), void *));
...
int bbs_enum_boards __P((SHORT, SHORT, SHORT, int (*)(int, BOARD *, void *), void *));
...
int bbs_enum_fileboards __P((SHORT, SHORT, int (*)(int, BOARD *, void *), void *));
...
/* Client-side functions shared across multiple .c files. */
int HasPerm __P((int));
int HasReadMenuPerm __P((int, int));
int SelectBoard __P((char *));
int OpenBoard __P((int *, int, int *));
int GenericPost __P((int));
int AnnotateMessageBody __P((char *, char *));
int Answer __P((void));
int do_echo __P((char *));
int do_exec __P((char *, char *));
int parse_default __P((void));
int parse_environment __P((char *));
int more __P((char *, int));
int vedit __P((char *));
int conv_init __P((char *));
int generic_abort __P((void));
int form_modechar_key __P((void));
int namecomplete __P((int (*)(NAMELIST *, char *), NAMELIST, char *, char *, int));
int home_bbs __P((char *));
int disconnect __P((int));
int Edit __P((char *));
int More __P((char *, int));
int ParseMenu __P((void));
int MenuGetch __P((void));
int MailReply __P((HEADER *, int, int, int));
